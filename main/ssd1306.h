...
typedef struct
{
    ...
    {
#if (SSD1306_I2C_SUPPORT)
        uint8_t addr;         //!< I2C devuce descriptor, used by SSD1306_PROTO_I2C
#endif
 ...
 * @return Non-zero if error occured
 */
int ssd1306_draw_rectangle(const ssd1306_t *dev, uint8_t *fb, int16_t x, int16_t y, uint8_t w, uint8_t h, ssd1306_color_t color);
 ...
 */
int ssd1306_draw_char(const ssd1306_t *dev, uint8_t *fb, const font_info_t *font, int16_t x, int16_t y, char c, ssd1306_color_t foreground, ssd1306_color_t background);
...
int ssd1306_draw_string(const ssd1306_t *dev, uint8_t *fb, const font_info_t *font, uint16_t x, uint16_t y,
                        const char *str, ssd1306_color_t foreground, ssd1306_color_t background);

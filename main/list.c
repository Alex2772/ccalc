...
void flist_init(struct list *list, int first_index) {
    // Create the mutex
...
int flist_add(struct list *list, void *item, int *item_index) {
...
int IRAM_ATTR flist_get(struct list *list, int index, void **item) {
...
int flist_remove(struct list *list, int index, int destroy) {
    struct list_index *cindex = NULL;
    int iindex;
...
int IRAM_ATTR flist_first(struct list *list) {
    int index;
    int res = -1;
...
int IRAM_ATTR flist_next(struct list *list, int index) {
    int res = -1;
    int iindex;
...
void flist_destroy(struct list *list, int items) {
    int index;

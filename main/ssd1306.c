...
int ssd1306_draw_pixel(const ssd1306_t *dev, uint8_t *fb, int16_t x, int16_t y, ssd1306_color_t color) {

    if ((x >= dev->width) || (x < 0) || (y >= dev->height) || (y < 0)) {
        return -EINVAL;
    }

    uint16_t index = (uint16_t) (x + (y / 8) * dev->width);
    switch (color) {
...
int ssd1306_draw_hline(const ssd1306_t *dev, uint8_t *fb, int16_t x, int16_t y, uint16_t w, ssd1306_color_t color) {
    uint16_t index;
    uint8_t mask, t;
...
int ssd1306_draw_vline(const ssd1306_t *dev, uint8_t *fb, int16_t x, int16_t y, uint16_t h, ssd1306_color_t color) {
    uint16_t index;
    uint8_t mask, mod, t;
...
int ssd1306_draw_rectangle(const ssd1306_t *dev, uint8_t *fb, int16_t x, int16_t y, uint8_t w, uint8_t h,
...
int ssd1306_fill_rectangle(const ssd1306_t *dev, uint8_t *fb, int16_t x, int16_t y, uint16_t w, uint16_t h,
                           ssd1306_color_t color) {
    // Can be optimized?
    for (int16_t jy = 0; jy < h; ++jy) {
        for (int16_t jx = 0; jx < w; ++jx) {
            ssd1306_draw_pixel(dev, fb, x + jx, y + jy, color);
        }
    }
    return 0;
}

int ssd1306_draw_circle(const ssd1306_t *dev, uint8_t *fb, int16_t x0, int16_t y0, int8_t r, ssd1306_color_t color) {
...
int ssd1306_draw_line(const ssd1306_t *dev, uint8_t *fb, int16_t x0, int16_t y0, int16_t x1, int16_t y1,
                      ssd1306_color_t color) {
...
int ssd1306_draw_triangle(const ssd1306_t *dev, uint8_t *fb, int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2,
                          int16_t y2,
                          ssd1306_color_t color) {
    int err;
...
int ssd1306_fill_triangle(const ssd1306_t *dev, uint8_t *fb, int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2,
                          int16_t y2,
                          ssd1306_color_t color) {
    int16_t a, b, y, last;
    int err;
...
int ssd1306_draw_char(const ssd1306_t *dev, uint8_t *fb, const font_info_t *font, int16_t x, int16_t y, char c,
    ...
    if (x + ((int16_t)d->width) < 0 || y + ((int16_t)font->height) < 0 || x > ((int16_t)dev->width) || y > ((int16_t)dev->height)) {
        return d->width;
    }
...
int ssd1306_draw_string(const ssd1306_t *dev, uint8_t *fb, const font_info_t *font, uint16_t x, uint16_t y,
                        const char *str,
    ...
    while (*str) {
        if (f) {
            f = false;
            err = ssd1306_draw_char(dev, fb, font_builtin_fonts[FONT_FACE_TERMINUS_6X12_KOI8_R], x, y, toKOI8(*str), foreground, background);
            x += err;
            ++str;
            if (*str)
                x += font->c;
        } else if (*str != (0b11010000) && *str != (0b11010001)) {
            err = ssd1306_draw_char(dev, fb, font, x, y, *str, foreground, background);
            x += err;
            ++str;
            if (*str)
                x += font->c;
